...
public class LunchMachineComprarView extends javax.swing.JFrame {
    ...
    private void cmdRegistrarCompraIgredienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdRegistrarCompraIgredienteActionPerformed
        switch(comboIngrediente.getItemCount()){
            
        }
//Ingrediente ingrediente=new Ingrediente(comboIngrediente.getItemAt(comboIngrediente.getItemCount()),Integer.parseInt(txtCantidadCompra.getText()),Integer.parseInt(txtPrecioCompra.getText()));
