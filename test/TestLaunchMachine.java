...
/**
 * The test class TestIngrediente.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class TestLaunchMachine {
    ...
    /**
     * Default constructor for test class TestIngrediente
     */
    ...
    @Test
    public void testIngredienteRegistrarVenta1() {
    ...
    @Test
    public void testIngredienteRegistrarCompra1() {
    ...
    @Test
    public void testIngredienteRegistrarVenta2() {
    ...
    @Test
    public void testIngredienteRegistrarCompra2() {
        int a = ((int) (Math.random() * 1000)) % 1000 + 1;
        int b = ((int) (Math.random() * 1000)) % 100 + 1;
        int x = 0, y = 0;
        Ingrediente ingrediente = null;
    ...
    @Test
    public void testIngredienteEquals() {
    ...
    @Test
    public void testAlmuerzoConstructor() {
        Restaurante r = new Restaurante();
        ArrayList<Ingrediente> ing = new ArrayList<Ingrediente>();
        for (int i = 0; i < ingredientes.length; i++) {
            ing.add(ingredientes[i]);
        }
    ...
    @Test
    public void testAlmuerzoPrecioVenta() {
        Restaurante r = new Restaurante();
        ArrayList<Ingrediente> ing = new ArrayList<Ingrediente>();
        for (int i = 0; i < ingredientes.length; i++) {
            ing.add(ingredientes[i]);
    ...
    @Test
    public void testAlmuerzoSePuedePrepararYRegistrarVenta() {
        Restaurante r = new Restaurante();
        ArrayList<Ingrediente> ing = new ArrayList<Ingrediente>();
        for (int i = 0; i < ingredientes.length; i++) {
            ing.add(ingredientes[i]);
    ...
    @Test
    public void testRestauranteGetNombres() {
        Restaurante r = new Restaurante();
        String[] s = null;
        ArrayList<Ingrediente> ing = new ArrayList<Ingrediente>();
        for (int i = 0; i < ingredientes.length; i++) {
    ...
    @Test
    public void testRestauranteBuscar() {
        Restaurante r = new Restaurante();
        String[] s = null;
        ArrayList<Ingrediente> ing = new ArrayList<Ingrediente>();
        for (int i = 0; i < ingredientes.length; i++) {
